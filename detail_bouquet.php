    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <?= "<img src='img/prodak/bouquet/" . $d['gb_bunga'] . "'style='width:420px; height:500px;border:3px solid grey;border-radius:3%;'>" ?>
        ...
        <div class="col-sm-6" style="margin-top:70px;">
          ...
          <form class="formproduk" method="POST" action="koneksi.php">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" name="jumlah" min="0" max="10" required>
            </div><br>
            <button type="submit" class="btn btn-primary" name="tambah" value="<?php echo $d['id_bunga'] ?>">Tambahkan Ke Keranjang</button>
          </form>
