    ...
    <div class="container-xxl">
      <div class="row">
        <div class="col-sm-2">
          ...
          <ul class="list-group">
            <li class="list-group-item"><a href="bouquet.php">Bouquet</a></li>
            <li class="list-group-item"><a href="box.php">Blossom Box</a></li>
            <li class="list-group-item"><a href="acrylicbox.php">Acrylic Blossom Box</a></li>
            <li class="list-group-item"><a href="vase.php">Vase</a></li>
          </ul>
        </div>
        <div class="col-sm-10">
          <div class="searchbox">
            <form action="bouquet.php" method="get">
              <div class="input-group">
                <input type="text" name="cari" class="form-control rounded" placeholder="Cari nama bunga yang anda inginkan disini.." aria-label="Search" aria-describedby="search-addon" />
          ...
          <div class="row">
            ...
            if (isset($_GET['cari'])) {
              $cari = $_GET['cari'];
              $data_bunga = mysqli_query($koneksi, "select * from prodak_bunga where id_kategori = 'K-001' && nama_bunga like '%" . $cari . "%' order by id_bunga desc limit $halaman_awal, $batas");
            } else {
              $data_bunga = mysqli_query($koneksi, "select * from prodak_bunga where id_kategori = 'K-001' order by id_bunga desc limit $halaman_awal, $batas");
            }
            $nomor = $halaman_awal + 1;
            while ($d = mysqli_fetch_array($data_bunga)) {
            ?>
              <div class="col-sm">
                <a href='detail_bouquet.php?id_bunga=<?= $d['id_bunga']; ?>'><?= "<img src='img/prodak/bouquet/" . $d['gb_bunga'] . "'style='width:250px; height:350px;'>" ?></a>
