                    ...
                    <div class="searchbox">
                      ...
                      <div class="row">
                        <?php 
                          ...
                          if(isset($_GET['cari'])){
                            $cari = $_GET['cari'];
                            $data_bunga = mysqli_query($koneksi,"select * from prodak_bunga where id_kategori = 'K-003' && nama_bunga like '%".$cari."%' order by id_bunga desc limit $halaman_awal, $batas");}
                          else{
                          $data_bunga = mysqli_query($koneksi,"select * from prodak_bunga where id_kategori = 'K-003' order by id_bunga desc limit $halaman_awal, $batas");}
                          $nomor = $halaman_awal+1;
                          while($d = mysqli_fetch_array($data_bunga)){
				                	?>
                            <div class="col-sm">
                            <a href='detail_box.php?id_bunga=<?= $d['id_bunga']; ?>'><?="<img src='img/prodak/box/".$d['gb_bunga']."'style='width:250px; height:350px;'>"?></a>
